    ...
    <section className="findus">
      ...
      <div className="findus__cards">
        ...
        <div className="findus__card findus__card--red">
          ...
          <p>Հեռ․: +374 99 397892</p>
          <p>
            Էլ․հասցե: <a href="marketing@379beer.am">marketing@379beer.am</a>
          </p>
        </div>
      </div>
    </section>
